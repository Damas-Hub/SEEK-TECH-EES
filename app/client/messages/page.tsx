...
export default function MessagesPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-[calc(100vh-120px)] gap-4">
      ...
      <div
        className={`md:w-1/3 bg-white rounded-lg shadow-sm overflow-hidden ${activeConversation ? "hidden md:block" : "block"}`}
      >
      ...
      {/* Chat area */}
      <div
        className={`flex-1 bg-white rounded-lg shadow-sm overflow-hidden flex flex-col ${!activeConversation ? "hidden md:flex" : "flex"}`}
      >
        {/* Chat header */}
