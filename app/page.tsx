...
const repairs = [
  {
    ...
    description:
      "Professional screen replacement for all smartphone models. Quick service with quality parts.",
    price: "From $49.99",
  ...
  },
  {
    ...
    description:
      "Complete system check to identify hardware and software issues. Detailed report included.",
    price: "From $29.99",
    image: "/placeholder.svg?height=200&width=300",
  },
  {
    ...
    description:
      "Extend your laptop's life with a new battery. Compatible with all major brands.",
    price: "From $59.99",
    image: "/placeholder.svg?height=200&width=300",
  },
  {
    ...
    title: "Data Recovery",
    description:
      "Recover lost or deleted files from hard drives, SSDs, and memory cards. Confidential service.",
    price: "From $79.99",
    image: "/placeholder.svg?height=200&width=300",
  },
  {
  ...
  },
  {
    ...
    description:
      "Fix for PlayStation, Xbox, and Nintendo consoles. HDMI ports, disc drives, and more.",
    price: "From $49.99",
    image: "/placeholder.svg?height=200&width=300",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 dark:text-gray-100">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl">
            <h1 className="text-4xl font-bold mb-4">
              Professional Repair Services & Quality Products
            </h1>
            <p className="text-xl mb-8">
              Expert repair services for all your devices and quality
              accessories to enhance your tech experience.
            </p>
            <div className="flex gap-4">
              ...
              <Link href="/store">
                <Button
                  variant="outline"
                  className="border-white text-white bg-blue-700/50 hover:bg-blue-700"
                >
                  Visit Our Store
                </Button>
              </Link>
      ...
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-2xl font-bold text-blue-800 dark:text-blue-400 mb-8">
          Featured Repair Services
        </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <address className="text-gray-300 not-italic">
                ...
                <p>Akuse City, TC 12345</p>
                <p className="mt-2">Phone: (123) 456-7890</p>
                <p>Email: info@sleektechsse.com</p>
              </address>
            </div>
          </div>
